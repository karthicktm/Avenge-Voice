...
[RULES]
- Default language is {language_name}. If the caller requests to switch languages, immediately honor it and continue in that language for the rest of the conversation.
