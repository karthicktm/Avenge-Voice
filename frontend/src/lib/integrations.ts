...
export const AVAILABLE_INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    name: "Site Search",
    slug: "site-search",
    description: "Intelligently crawl and search a configured website during calls",
    category: "other",
    authType: "none",
    ...
    fields: [
      {
        ...
        description: "The website to crawl and search during calls",
      },
      {
        ...
        type: "text",
        required: false,
        placeholder: "Apartment listings, product catalog, company info...",
        description: "Describe what this site contains to help the AI search more effectively",
      },
    ],
    tools: [
      {
        id: "search_site",
        name: "Search Site",
        description: "Intelligently crawl and extract information from the configured website",
        riskLevel: "safe",
        defaultEnabled: true,
      },
    ],
